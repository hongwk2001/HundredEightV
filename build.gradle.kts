...
// Or the latest version
    ...
    // For loading and tinting drawables on older versions of the platform (optional but often useful)
    implementation(libs.androidx.appcompat.resources) // Use the same version as appcompat
